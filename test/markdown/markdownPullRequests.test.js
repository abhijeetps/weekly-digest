...
test('that checks return string if there is one pull request', () => {
  ...
  expect(markdownPullRequests(openPullRequest, headDate, tailDate)).toContain(':green_heart: #15 [Weekly Digest test15](https://github.com/aps120797/playground/pull/15), by [aps120797](https://github.com/aps120797)')
  expect(markdownPullRequests(openPullRequest, headDate, tailDate)).toContain(':green_heart: #14 [Weekly Digest test14](https://github.com/aps120797/playground/pull/14), by [aps120797](https://github.com/aps120797)')
})
...
test('that checks return string if there are updated pull requests', () => {
  ...
  expect(markdownPullRequests(updatedPullRequest, headDate, tailDate)).toContain(':yellow_heart: #17 [Weekly Digest test17](https://github.com/aps120797/playground/pull/17), by [aps120797](https://github.com/aps120797)')
  expect(markdownPullRequests(updatedPullRequest, headDate, tailDate)).toContain(':yellow_heart: #16 [Weekly Digest test16](https://github.com/aps120797/playground/pull/16), by [aps120797](https://github.com/aps120797)')
})
...
test('that checks return string if there are merged pull requests', () => {
  ...
  expect(markdownPullRequests(mergedPullRequest, headDate, tailDate)).toContain(':purple_heart: #25 [Weekly Digest test25](https://github.com/aps120797/playground/pull/25), by [aps120797](https://github.com/aps120797)')
  expect(markdownPullRequests(mergedPullRequest, headDate, tailDate)).toContain(':purple_heart: #24 [Weekly Digest test24](https://github.com/aps120797/playground/pull/24), by [aps120797](https://github.com/aps120797)')
})
...
test('that checks return string if there are some pull requests', () => {
  ...
  expect(markdownPullRequests(allPullRequest, headDate, tailDate)).toContain(':green_heart: #14 [Weekly Digest test14](https://github.com/aps120797/playground/pull/14), by [aps120797](https://github.com/aps120797)')
  ...
  expect(markdownPullRequests(allPullRequest, headDate, tailDate)).toContain(':yellow_heart: #16 [Weekly Digest test16](https://github.com/aps120797/playground/pull/16), by [aps120797](https://github.com/aps120797)')
  ...
  expect(markdownPullRequests(allPullRequest, headDate, tailDate)).toContain(':purple_heart: #24 [Weekly Digest test24](https://github.com/aps120797/playground/pull/24), by [aps120797](https://github.com/aps120797)')
})
...
test('that checks return string if the pull requests is null', () => {
  ...
  expect(markdownPullRequests(onePullRequest, headDate, tailDate)).toContain(':green_heart: #14 [Weekly Digest test14](https://github.com/aps120797/playground/pull/14), by [aps120797](https://github.com/aps120797)')
})
